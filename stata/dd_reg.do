...
//Set Directory Paths
local root 	"/Users/rmadhok/Dropbox (Personal)/ebird_lockdown"
*===============================================================================

* Clean
foreach file in dd_t20_2trips dd_t20_5trips dd_t20_10trips ///
	dd_all_2trips dd_t20_2trips_home {
	...
	* Clean
	...
	gen stationary = (protocoltype == "Stationary")
...
eststo m1: reghdfe s_richness treatpost treatment post ///
	durationminutes rain temperature numberobservers hotspot_km  ///
...
reghdfe s_richness treatpost treatment post ///
	durationminutes rain temperature  stationary weekend, ///
...
* Top 20, 2 trips, home
use "`dd_t20_2trips_home'", clear

eststo m5: reghdfe s_richness treatpost treatment post ///
	durationminutes rain temperature numberobservers hotspot_km ///
	stationary weekend, a(dist_id hour) vce(r)
...
eststo m2020: regress s_richness post durationminutes rain temperature ///
	numberobservers stationary weekend numberobservers hotspot_km ///
	i.user_id i.dist_id i.hour if year == 2020,

eststo m2019: regress s_richness post durationminutes rain temperature ///
	numberobservers stationary weekend numberobservers hotspot_km  ///
...
* Tabulate
esttab m1 m5 m6 m2 m3 m4 using "`root'/tables/dd_reg.tex", replace ///
	stats(pcp location home dist_fe hour_fe user_fe N r2, ///
	labels(`"Partip. Constraint"' `"Location Constraint"' `"Home"' ///
	`"District FEs"' `"Hour FEs"' `"User FEs"' `"N"'  `"\(R^{2}\)"') ///
	fmt(0 0 0 0 0 0 0 3)) mgroups("Preferred" "Robustness", ///
